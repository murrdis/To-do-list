...
struct Images {
    static let plusCircle = UIImage(named: "plus_circle_24x24")
    ...
    static let priorityLow = UIImage(named: "priority_low")
    static let showOff = UIImage(named: "show_off")
    static let showOn = UIImage(named: "show_on")
}
